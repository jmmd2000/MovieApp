          ...
          return GridView(
            ...
            children: snapshot.data!.docs
                .map((DocumentSnapshot document) {
                  ...
                  Movie m = Movie(data['posterPath'], data['adult'], data['overview'], data['releaseDate'], data['genres'].cast<int>(), data['id'], data['originalTitle'], data['backdropPath'],
                      data['voteCount'], data['voteAverage'].toString(), s);
